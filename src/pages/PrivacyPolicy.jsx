      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="bg-[#0b101e] rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 text-white relative overflow-hidden border border-slate-800 shadow-2xl mb-12">
          ...
          <div className="relative z-10 text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 text-blue-400 text-xs sm:text-sm font-bold mb-4 border border-blue-500/20">
              <Shield size={16} />
        ...
        <div className="bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 border border-slate-100 shadow-[0_15px_35px_-15px_rgba(0,0,0,0.05)] text-left space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
              <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                <h3 className="font-bold text-slate-900 mb-2">Personal Info</h3>
                <ul className="text-slate-500 text-sm font-semibold space-y-1.5 list-disc pl-4">
                  <li>Name</li>
                  <li>Email address</li>
                  <li>Phone number</li>
              ...
              <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                <h3 className="font-bold text-slate-900 mb-2">Location Info</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <h4 className="font-bold text-slate-900 mb-2">Retention Policy</h4>
                <p className="text-slate-500 text-sm font-semibold leading-relaxed">
              ...
              <div>
                <h4 className="font-bold text-slate-900 mb-2">Third-Party Services</h4>
                <p className="text-slate-500 text-sm font-semibold leading-relaxed">
          ...
          <div className="bg-[#eff6ff] rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="text-left">
              <h3 className="font-bold text-slate-900 text-lg">Have questions?</h3>
              <p className="text-slate-500 text-sm font-semibold mt-1">Contact our privacy team for inquiries.</p>
            </div>
            <a
              href="mailto:navixgosupport@gmail.com"
              className="inline-flex items-center gap-2 bg-[#0056b3] text-white px-5 py-3 rounded-full font-bold hover:bg-[#004494] transition-all transform hover:scale-105 active:scale-95 text-sm"
            >
              <Mail size={16} />
